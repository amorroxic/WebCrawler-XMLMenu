...
class Crawler_Reporter_Pdf extends Crawler_Reporter_Core {
	...
	protected function output() {
		...
		try {
			...
			$filename = $baseDownloadPath . "/storage/pdf/" . $this->_cacheKey . ".pdf";
			...
			header("Content-Disposition: attachment; filename=\""."cached-assets.pdf"."\";" );
